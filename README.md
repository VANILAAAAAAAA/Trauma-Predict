...
The matched baseline delivery surface is `notebooks/kaggle/trauma_predict_grud_h1_joint_m4_v2.ipynb`. It binds the private GRU-D science bundle and reuses only the verified P100 runtime archive from the Relation V2 Dataset. It starts fresh at step 0, trains through step 4000 without a forced stop or resume dependency, selects checkpoints by fixed 505-subject validation NLL, and exports the selected and step-4000 checkpoints. Full 6,309-anchor teacher-forced evaluation and free-running evaluation are separate jobs.
