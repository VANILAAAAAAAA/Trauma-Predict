...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Train the fresh single-P100 GRU-D H1 to joint six-M4 baseline."
    )
...
def main() -> int:
    ...
    print(
        f"GRUD_V2_NOTEBOOK_START config={args.config.resolve()} mode=fresh target_step=4000",
        flush=True,
    )
