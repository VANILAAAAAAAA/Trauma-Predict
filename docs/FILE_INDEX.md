...
| `notebooks/kaggle/train_multires_event_v2.ipynb` | kaggle | Released zero-Input two-cell formal block Notebook pinned to immutable r7; the in-process capacity gate precedes formal optimizer step one. | No embedded data. |
